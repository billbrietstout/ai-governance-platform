...
This proposal is based on the document _AI Vendor types and VRA security questions_ (PDF at `/Users/billstout/Downloads/`). It maps the document's five vendor categories and their key risk assessment question areas to the AI Posture Platform's supply chain and vendor management.
