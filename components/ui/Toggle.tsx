  ...
  return (
    <button
      ...
      className={`
        ...
        transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-navy-500 focus:ring-offset-2
    ...
    >
      <span
        className={`
          ...
          transition duration-200 ease-in-out ${thumbClasses} ${thumbTranslate}
        `}
      />
    </button>
  );
