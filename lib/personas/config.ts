...
export const PERSONA_CONFIGS: Record<PersonaId, PersonaConfig> = {
  CEO: {
    ...
    defaultLandingPage: "/layer1-business",
    visibleLayers: ["L1"],
  ...
  CFO: {
    ...
    defaultLandingPage: "/layer1-business?tab=cfo",
    visibleLayers: ["L1"],
    visibleSections: ["GOVERNANCE OVERVIEW", "LAYER 1: BUSINESS"],
  ...
  COO: {
    ...
    defaultLandingPage: "/layer1-business?tab=coo",
    visibleLayers: ["L1", "L3"],
  ...
  LEGAL: {
    ...
    defaultLandingPage: "/layer1-business?tab=legal",
  ...
  DEV_LEAD: {
    ...
    defaultLandingPage: "/layer3-application",
    visibleLayers: ["L3", "L4"],
    visibleSections: [
      "GOVERNANCE OVERVIEW",
      "LAYER 3: APPLICATION",
  ...
  VENDOR_MGR: {
    ...
    defaultLandingPage: "/layer5-supply-chain",
    visibleLayers: ["L5", "L1"],
    visibleSections: [
      "GOVERNANCE OVERVIEW",
      "LAYER 1: BUSINESS",
