...
export const USE_CASES: UseCase[] = [
  ...
  },
  {
    ...
    applicableRegulations: ["EU_AI_ACT", "NIST_AI_RMF", "OWASP_AIVSS"],
  ...
  },
  {
    ...
    businessFunction: "Finance",
    typicalDataTypes: ["Financial", "PII"],
    applicableRegulations: ["EU_AI_ACT", "DORA", "SR_11_7", "GDPR_AI", "OWASP_AIVSS"],
  ...
  },
  {
    ...
    applicableRegulations: ["EU_AI_ACT", "SEC_AI", "SR_11_7", "DORA", "OWASP_AIVSS"],
  ...
  },
  {
    ...
    businessFunction: "Customer Service",
    typicalDataTypes: ["PII", "Proprietary"],
    applicableRegulations: ["EU_AI_ACT", "GDPR_AI", "OWASP_AIVSS"],
    requiredControls: ["Transparency", "Data governance"],
    estimatedMaturity: 3,
    governanceComplexity: "MEDIUM",
    templateInputs: {
