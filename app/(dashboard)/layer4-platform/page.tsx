  ...
  const cards = [
    {
      ...
      stats: [
        ...
        { label: "Coverage", value: `${telemetry.data.summary.coveragePercent}%` },
        {
          ...
          alert: telemetry.data.summary.criticalFindings > 0
        }
      ]
    },
    {
      ...
      stats: [
        {
          ...
          value: drift.data.summary.flaggedAssets,
          alert: drift.data.summary.flaggedAssets > 0
        },
        {
          label: "HIGH Severity",
          value: drift.data.summary.bySeverity.HIGH,
          alert: drift.data.summary.bySeverity.HIGH > 0
        },
    ...
    },
    {
      ...
      stats: [
        {
          label: "Critical",
          value: alerts.data.bySeverity.CRITICAL,
          alert: alerts.data.bySeverity.CRITICAL > 0
        },
        {
          label: "High",
          value: alerts.data.bySeverity.HIGH,
          alert: alerts.data.bySeverity.HIGH > 0
        },
