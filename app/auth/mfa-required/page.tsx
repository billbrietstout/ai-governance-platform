    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-md rounded-lg border border-slate-200 bg-white p-8 shadow-sm">
        <div className="flex justify-center">
          <ShieldLogo className="h-12 w-12 text-navy-600" />
        </div>
        ...
        <div className="mt-6 rounded-lg border border-amber-200 bg-amber-50 p-4">
          <p className="text-sm text-amber-800">
            Click the button below to sign in again. You&apos;ll be prompted to enroll in MFA
        ...
        <div className="mt-6 flex flex-col gap-3">
          <Link
            ...
            className="flex w-full items-center justify-center rounded-lg bg-navy-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-navy-500"
          >
            Set Up MFA & Sign In
          </Link>
          <Link
